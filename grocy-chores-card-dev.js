...
type: 'grocy-chores-card-test',
name: 'Grocy Chores and Tasks Card Test',
preview: false,
description: 'A card used to test display chores and/or tasks from the Grocy custom component.',
});

customElements.define('grocy-chores-card-test', GrocyChoresCard);